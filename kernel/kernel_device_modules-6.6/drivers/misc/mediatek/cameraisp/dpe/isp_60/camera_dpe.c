...
//#include <linux/drivers/iommu/mtk_iommu.h>
//#include <mtk_iommu.h>
#include <linux/iommu.h>
#define CMdq_en
#define DPE_WR32_en
...
#endif
/*#define DPE_PMQOS_EN*/
#if defined(DPE_PMQOS_EN) && IS_ENABLED(CONFIG_MTK_QOS_SUPPORT)
...
struct DPE_CLK_STRUCT {
	...
	struct clk *CG_IPE_SMI_SUBCOM;
	struct clk *CG_IPESYS_DPE;
	struct clk *CG_IPE_LARB19;
	struct clk *CG_IPE_LARB20;
};
...
void DPE_DumpUserSpaceReg(struct DPE_Kernel_Config *pDpeConfig)
{
	...
	LOG_INF("DVS_ME_00 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_00);
	LOG_INF("DVS_ME_01 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_01);
	LOG_INF("DVS_ME_02 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_02);
	LOG_INF("DVS_ME_03 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_03);
	LOG_INF("DVS_ME_04 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_04);
	LOG_INF("DVS_ME_05 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_05);
	LOG_INF("DVS_ME_06 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_06);
	LOG_INF("DVS_ME_07 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_07);
	LOG_INF("DVS_ME_08 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_08);
	LOG_INF("DVS_ME_09 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_09);
	LOG_INF("DVS_ME_10 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_10);
	LOG_INF("DVS_ME_11 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_11);
	LOG_INF("DVS_ME_12 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_12);
	LOG_INF("DVS_ME_13 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_13);
	LOG_INF("DVS_ME_14 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_14);
	LOG_INF("DVS_ME_15 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_15);
	LOG_INF("DVS_ME_16 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_16);
	LOG_INF("DVS_ME_17 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_17);
	LOG_INF("DVS_ME_18 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_18);
	LOG_INF("DVS_ME_19 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_19);
	LOG_INF("DVS_ME_20 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_20);
	LOG_INF("DVS_ME_21 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_21);
	LOG_INF("DVS_ME_22 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_22);
	LOG_INF("DVS_ME_23 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_23);
	LOG_INF("DVS_ME_24 = 0x%08X\n", pDpeConfig->TuningBuf_ME.DVS_ME_24);
	LOG_INF("DVS_OCC_PQ_0 = 0x%08X\n", pDpeConfig->TuningBuf_OCC.DVS_OCC_PQ_0);
	LOG_INF("DVS_OCC_PQ_1 = 0x%08X\n", pDpeConfig->TuningBuf_OCC.DVS_OCC_PQ_1);
	LOG_INF("DVS_OCC_PQ_2 = 0x%08X\n", pDpeConfig->TuningBuf_OCC.DVS_OCC_PQ_2);
	LOG_INF("DVS_OCC_PQ_3 = 0x%08X\n", pDpeConfig->TuningBuf_OCC.DVS_OCC_PQ_3);
	LOG_INF("DVS_OCC_PQ_4 = 0x%08X\n", pDpeConfig->TuningBuf_OCC.DVS_OCC_PQ_4);
	LOG_INF("DVS_OCC_PQ_5 = 0x%08X\n", pDpeConfig->TuningBuf_OCC.DVS_OCC_PQ_5);
	...
	LOG_INF("DVP_CORE_00 = 0x%08X\n", pDpeConfig->TuningBuf_CORE.DVP_CORE_00);
	LOG_INF("DVP_CORE_01 = 0x%08X\n", pDpeConfig->TuningBuf_CORE.DVP_CORE_01);
	LOG_INF("DVP_CORE_02 = 0x%08X\n", pDpeConfig->TuningBuf_CORE.DVP_CORE_02);
	LOG_INF("DVP_CORE_03 = 0x%08X\n", pDpeConfig->TuningBuf_CORE.DVP_CORE_03);
	LOG_INF("DVP_CORE_04 = 0x%08X\n", pDpeConfig->TuningBuf_CORE.DVP_CORE_04);
	LOG_INF("DVP_CORE_05 = 0x%08X\n", pDpeConfig->TuningBuf_CORE.DVP_CORE_05);
	LOG_INF("DVP_CORE_06 = 0x%08X\n", pDpeConfig->TuningBuf_CORE.DVP_CORE_06);
	LOG_INF("DVP_CORE_07 = 0x%08X\n", pDpeConfig->TuningBuf_CORE.DVP_CORE_07);
	LOG_INF("DVP_CORE_08 = 0x%08X\n", pDpeConfig->TuningBuf_CORE.DVP_CORE_08);
	LOG_INF("DVP_CORE_09 = 0x%08X\n", pDpeConfig->TuningBuf_CORE.DVP_CORE_09);
	LOG_INF("DVP_CORE_10 = 0x%08X\n", pDpeConfig->TuningBuf_CORE.DVP_CORE_10);
	LOG_INF("DVP_CORE_11 = 0x%08X\n", pDpeConfig->TuningBuf_CORE.DVP_CORE_11);
	LOG_INF("DVP_CORE_12 = 0x%08X\n", pDpeConfig->TuningBuf_CORE.DVP_CORE_12);
	LOG_INF("DVP_CORE_13 = 0x%08X\n", pDpeConfig->TuningBuf_CORE.DVP_CORE_13);
	LOG_INF("DVP_CORE_14 = 0x%08X\n", pDpeConfig->TuningBuf_CORE.DVP_CORE_14);
	LOG_INF("DVP_CORE_15 = 0x%08X\n", pDpeConfig->TuningBuf_CORE.DVP_CORE_15);
...
#define CMDQWR_ME(REG) \
	cmdq_pkt_write(handle, dpe_clt_base, \
	REG ##_HW, pDpeConfig->TuningBuf_ME.REG, CMDQ_REG_MASK)
#define CMDQWR_OCC(REG) \
	cmdq_pkt_write(handle, dpe_clt_base, \
	REG ##_HW, pDpeConfig->TuningBuf_OCC.REG, CMDQ_REG_MASK)
#define CMDQWR_DVP_CORE(REG) \
	cmdq_pkt_write(handle, dpe_clt_base, \
	REG ##_HW, pDpeConfig->TuningBuf_CORE.REG, CMDQ_REG_MASK)
...
if (pDpeConfig->DPE_MODE != 2) {
	...
	CMDQWR_ME(DVS_ME_23);
	CMDQWR_ME(DVS_ME_24);
	CMDQWR_OCC(DVS_OCC_PQ_0);
	CMDQWR_OCC(DVS_OCC_PQ_1);
	CMDQWR_OCC(DVS_OCC_PQ_2);
	CMDQWR_OCC(DVS_OCC_PQ_3);
	CMDQWR_OCC(DVS_OCC_PQ_4);
	CMDQWR_OCC(DVS_OCC_PQ_5);
#endif
/* CRC EN, CRC SEL =0x0 */
/* cmdq_pkt_write(handle, dpe_clt_base, */
...
if (pDpeConfig->DPE_MODE != 1) {
	...
	CMDQWR_DVP_CORE(DVP_CORE_00);
	CMDQWR_DVP_CORE(DVP_CORE_01);
	CMDQWR_DVP_CORE(DVP_CORE_02);
	CMDQWR_DVP_CORE(DVP_CORE_03);
	CMDQWR_DVP_CORE(DVP_CORE_04);
	CMDQWR_DVP_CORE(DVP_CORE_05);
	CMDQWR_DVP_CORE(DVP_CORE_06);
	CMDQWR_DVP_CORE(DVP_CORE_07);
	CMDQWR_DVP_CORE(DVP_CORE_08);
	CMDQWR_DVP_CORE(DVP_CORE_09);
	CMDQWR_DVP_CORE(DVP_CORE_10);
	CMDQWR_DVP_CORE(DVP_CORE_11);
	CMDQWR_DVP_CORE(DVP_CORE_12);
	CMDQWR_DVP_CORE(DVP_CORE_13);
	CMDQWR_DVP_CORE(DVP_CORE_14);
	CMDQWR_DVP_CORE(DVP_CORE_15);
#endif
...
#endif
#ifdef SMI_CLK
	pm_runtime_get_sync(gdev);
	// LOG_INF("ccf_DPE_pdev->dev =%x\n", &DPE_pdev->dev);
	// LOG_INF("ccf_DPE_devs->larb19 =%x\n", DPE_devs->larb19);
	// LOG_INF("ccf_DPE_devs->larb20 =%x\n", DPE_devs->larb20);
#if CHECK_SERVICE_IF_0
	ret = mtk_smi_larb_get(DPE_devs->larb19);
	if (ret)
		LOG_INF("mtk_smi_larb19_get larbvdec fail\n");
	ret = mtk_smi_larb_get(DPE_devs->larb20);
	if (ret)
		LOG_INF("mtk_smi_larb20_get larbvdec fail\n");
#endif
#endif
	ret = clk_prepare_enable(dpe_clk.CG_IPE_SMI_SUBCOM);
	if (ret)
		LOG_ERR("cannot prepare and enable CG_IPE_SMI_SUBCOM clock\n");
	ret = clk_prepare_enable(dpe_clk.CG_IPE_LARB19);
	if (ret)
		LOG_ERR("cannot prepare and enable CG_IPE_LARB19 clock\n");
	ret = clk_prepare_enable(dpe_clk.CG_IPE_LARB20);
	if (ret)
		LOG_ERR("cannot prepare and enable CG_IPE_LARB20 clock\n");
	...
	struct DPE_REG_IO_STRUCT *data)
{
	...
	if (copy_to_user(compat_ptr(arg), &data32,
			sizeof(struct compat_DPE_REG_IO_STRUCT)) != 0) {
	...
	struct DPE_Request *data)
{
	...
	data->m_pDpeConfig = compat_ptr(data32.m_pDpeConfig);
...
{	
	...
	if (copy_to_user(compat_ptr(arg), &data32,
			sizeof(struct compat_DPE_Request)) != 0) {
		LOG_NOTICE("copy_to_user failed");
		ret = -EFAULT;
	}
	return ret;
							...
							unsigned long arg)
{
	...
	case COMPAT_DPE_READ_REGISTER:
	{
		...
		err = compat_get_DPE_read_register_data(arg, &data);
		if (err) {
		...
		ret =
		    filp->f_op->unlocked_ioctl(filp, DPE_READ_REGISTER,
					       (unsigned long)&data);
		err = compat_put_DPE_read_register_data(arg, &data);
		if (err) {
	...
	case COMPAT_DPE_ENQUE_REQ:
	{
		...
		err = compat_get_DPE_enque_req_data(arg, &data);
		if (err) {
			LOG_INF("COMPAT_GET_DPE_ENQUE_REQ error!!!\n");
			return err;
		}
		ret =
		    filp->f_op->unlocked_ioctl(filp, DPE_ENQUE_REQ,
					       (unsigned long)&data);
		err = compat_put_DPE_enque_req_data(arg, &data);
		if (err) {
			LOG_INF("COMPAT_PUT_DPE_ENQUE_REQ error!!!\n");
			return err;
		}
		return ret;
	}
	case COMPAT_DPE_DEQUE_REQ:
	{
		...
		err = compat_get_DPE_deque_req_data(arg, &data);
		if (err) {
			LOG_INF("COMPAT_GET_DPE_DEQUE_REQ error!!!\n");
			return err;
		}
		ret =
		    filp->f_op->unlocked_ioctl(filp, DPE_DEQUE_REQ,
					       (unsigned long)&data);
		err = compat_put_DPE_deque_req_data(arg, &data);
		if (err) {
			LOG_INF("COMPAT_PUT_DPE_DEQUE_REQ error!!!\n");
			return err;
		}
		return ret;
	}
 ...
 *
 ******************************************************************************/
static void DPE_add_device_link(struct platform_device *pDev)
{
...
if (DPE_dev->irq > 0) {
	...
	if (dma_set_mask_and_coherent(DPE_dev->dev, DMA_BIT_MASK(34)))
		dev_info(DPE_dev->dev, "%s: arm64: No suitable DMA available, DMA_BIT_MASK(34)\n",
			pDev->dev.of_node->name);
#else
	if (dma_set_mask_and_coherent(DPE_dev->dev, DMA_BIT_MASK(31)))
		dev_info(DPE_dev->dev, "%s: arm: No suitable DMA available, DMA_BIT_MASK(31)\n",
			pDev->dev.of_node->name);
#endif
	...
	DPE_devs->larb20 = &DPE_pdev->dev;
		...
		dpe_clk.CG_IPE_SMI_SUBCOM = devm_clk_get(&pDev->dev,
							"DPE_CLK_IPE_SMI_SUBCOM");
		if (IS_ERR(dpe_clk.CG_IPE_SMI_SUBCOM)) {
			LOG_ERR("cannot get CG_IPE_SMI_SUBCOM clock\n");
			return PTR_ERR(dpe_clk.CG_IPE_SMI_SUBCOM);
		}
		...
		dpe_clk.CG_IPE_LARB19 = devm_clk_get(&pDev->dev,
							"DPE_CLK_IPE_LARB19");
		if (IS_ERR(dpe_clk.CG_IPE_LARB19)) {
			LOG_ERR("cannot get CG_IPE_LARB19 clock\n");
			return PTR_ERR(dpe_clk.CG_IPE_LARB19);
		}
		dpe_clk.CG_IPE_LARB20 = devm_clk_get(&pDev->dev,
							"DPE_CLK_IPE_LARB20");
		if (IS_ERR(dpe_clk.CG_IPE_LARB20)) {
			LOG_ERR("cannot get CG_IPE_LARB20 clock\n");
			return PTR_ERR(dpe_clk.CG_IPE_LARB20);
		}
#endif
#endif
