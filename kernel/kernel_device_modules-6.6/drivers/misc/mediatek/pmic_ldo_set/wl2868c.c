...
#include "../include/mt-plat/upmu_hw.h"
#include "../include/mt-plat/upmu_common.h"
/*#include "../../../../../../vendor/oplus/kernel/system/include/oplus_project.h"*/
#include <soc/oplus/system/oplus_project.h>
#include <soc/oplus/device_info.h>
/*#include "../../../../../../vendor/oplus/kernel/device_info/device_info/device_info.h"*/
#endif
...
EXPORT_SYMBOL(wl2868c_test_i2c_enable);
#if !defined(CONFIG_MTK_PMIC_CHIP_MT6358)
/*!
...
EXPORT_SYMBOL(wl2868c_ldo_2_set_voltage);
...
static int wl2868c_probe(struct i2c_client *client)
{
	...
	mutex_lock(&gRegisterLocker);
	wl2868c_data.ldo_en_select = 132;
	mutex_unlock(&gRegisterLocker);
 ...
 * @return  Error code indicating success or failure
 */
static void wl2868c_remove(struct i2c_client *client)
{
